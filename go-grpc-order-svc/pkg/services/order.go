...
import (
	...
	"github.com/charlieaular/go-grpc-order-svc/pkg/client"
	"github.com/charlieaular/go-grpc-order-svc/pkg/db"
	"github.com/charlieaular/go-grpc-order-svc/pkg/models"
	"github.com/charlieaular/go-grpc-order-svc/pkg/pb"
)
...
func (s *Server) CreateOrder(ctx context.Context, req *pb.CreateOrderRequest) (*pb.CreateOrderResponse, error) {
	...
	fmt.Printf("productStock: %v, reqQuantity: %v, productId: %v", product.Data.Stock, req.Quantity, req.ProductId)
